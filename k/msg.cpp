...
namespace k
{  
uri::uri(const string msg)
{
    message = msg;
    analyze();
  
}     
int uri::analyze()    //解析协议
{     int end=0;
...
uri::uri(const string request_type,const string service_name,const string ip,const string  port)
{    
